 ...
 * </p>
 * <ul>
 *   <li>{@link xacro.impl.BoxImpl#getSize <em>Size</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoxImpl extends MinimalEObjectImpl.Container implements Box
{
	...
	public void setSize(ParameterString newSize)
	{
		if (newSize != size) {
			...
			if (size != null)
				msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XacroPackage.BOX__SIZE, null, msgs);
			if (newSize != null)
				msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XacroPackage.BOX__SIZE, null, msgs);
			msgs = basicSetSize(newSize, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XacroPackage.BOX__SIZE, newSize, newSize));
	}
